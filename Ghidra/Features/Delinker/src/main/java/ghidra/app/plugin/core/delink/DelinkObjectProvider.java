...
/*
		...
		setVisible(true);
*/
		DelinkSymbolTableModel symbolTableModel = new DelinkSymbolTableModel(this, plugin.getTool());
		DelinkSymbolPanel symbolPanel = new DelinkSymbolPanel(plugin, symbolTableModel, plugin.getTool());
		this.panel.addTab("Symbols", symbolPanel);

		DelinkReferenceTableModel referenceTableModel = new DelinkReferenceTableModel(this, plugin.getTool(), plugin.getCurrentProgram());
		DelinkReferencePanel referencePanel = new DelinkReferencePanel(plugin, referenceTableModel, plugin.getTool());
